...
import { uploadNotice } from '../../actions/uploadNotice'
import { getNotice } from '../../actions/getNotice'
import { getNotices } from '../../actions/getNotices'
import { editNotice } from '../../actions/editNotice'
import NoticeEditor from './UploadNoticeEditor'
...
const mapStateToProps = state => {
    return {
        ...
        narrowBookmark: state.notices.narrowBookmark,
        isUploading: state.notices.isUploading,
